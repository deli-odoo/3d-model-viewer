...
const placeholder = "/3d-model-viewer/static/glb/placeholder.glb";
  ...
  setup() {
    ...
    onWillStart(async () => {
      if (!this.windowState.jsLibLoaded) {
        await loadJSModule("/3d-model-viewer/static/lib/model-viewer.min.js");
...
ModelViewerField.template = "3d-model-viewer.ModelViewerField";
